...
app.get("/scores", function (req, res) {
  Player.find({}, function (err, players) {
    if (err) {
      ...
      let playersEasy = players.filter((obj) => {
        return obj.difficulty === "easy";
      });
      playersEasy.sort((a, b) => {
        return b.score - a.score;
      });
      let playersNormal = players.filter((obj) => {
        return obj.difficulty === "normal";
      });
      playersNormal.sort((a, b) => {
        return b.score - a.score;
      });
      let playersHard = players.filter((obj) => {
        return obj.difficulty === "hard";
      });
      playersHard.sort((a, b) => {
        return b.score - a.score;
      });
      res.render("scores", {
        playersEasy: playersEasy,
        playersNormal: playersNormal,
